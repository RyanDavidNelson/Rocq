...
(* NB: the conclusion below is a vacuous placeholder ([True]); stating the
   genuine limit law P(I/E[I] >= t) ---> exp(-t) needs analysis's limit
   infrastructure.  The physical content is Goodman's CLT result, assumed. *)
